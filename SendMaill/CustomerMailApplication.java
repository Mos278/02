...
public class CustomerMailApplication {
    ...
    public static void main(String[] args) {
        ...
        switch(customerType) {
            case "Regular":
                customer = new R_CustomerMailFactory().creaCustomer();
                break;
            case "Mountain":
                customer = new M_CustomerMailFactory().creaCustomer();
                break;
            case "Delinquent":
                customer = new D_CustomerMailFactory().creaCustomer();
                break; 
        }
        CustomerMailApplication app = new CustomerMailApplication(customer);
        System.out.println(app.generateMail());   
        System.out.println(app.sentBrochure());       
    }
